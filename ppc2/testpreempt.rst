      ...
      000000 02 00 E1         [24]  291 	ljmp	__sdcc_gsinit_startup
      000003 32               [24]  292 	reti
      000004                        293 	.ds	7
      00000B 02 00 E8         [24]  294 	ljmp	_timer0_ISR
      ...
      000051 02 00 CF         [24]  374 	ljmp	_main
                                    ...
                                    382 ;------------------------------------------------------------
                                    383 ;	testpreempt.c:21: void Producer(void)
                                    384 ;	-----------------------------------------
      ...
      000081                        387 _Producer:
                           ...
                           000001   394 	ar1 = 0x01
                           000000   395 	ar0 = 0x00
                                    396 ;	testpreempt.c:23: nextCharacter = 'A';
      000081 75 32 41         [24]  397 	mov	_nextCharacter,#0x41
                                    398 ;	testpreempt.c:33: while (bufferFull)
      000084                        399 00101$:
      000084 E5 31            [12]  400 	mov	a,_bufferFull
      000086 70 FC            [24]  401 	jnz	00101$
                                    402 ;	testpreempt.c:41: EA = 0;
                                    403 ;	assignBit
      000088 C2 AF            [12]  404 	clr	_EA
                                    405 ;	testpreempt.c:47: if (!bufferFull)
      00008A E5 31            [12]  406 	mov	a,_bufferFull
      00008C 70 15            [24]  407 	jnz	00108$
                                    408 ;	testpreempt.c:49: sharedBuffer = nextCharacter;
      00008E 85 32 30         [24]  409 	mov	_sharedBuffer,_nextCharacter
                                    410 ;	testpreempt.c:50: bufferFull = 1;
      000091 75 31 01         [24]  411 	mov	_bufferFull,#0x01
                                    412 ;	testpreempt.c:55: if (nextCharacter == 'Z')
      000094 74 5A            [12]  413 	mov	a,#0x5a
      000096 B5 32 05         [24]  414 	cjne	a,_nextCharacter,00105$
                                    415 ;	testpreempt.c:57: nextCharacter = 'A';
      000099 75 32 41         [24]  416 	mov	_nextCharacter,#0x41
      00009C 80 05            [24]  417 	sjmp	00108$
      00009E                        418 00105$:
                                    419 ;	testpreempt.c:61: nextCharacter++;
      00009E E5 32            [12]  420 	mov	a,_nextCharacter
      0000A0 04               [12]  421 	inc	a
      0000A1 F5 32            [12]  422 	mov	_nextCharacter,a
      0000A3                        423 00108$:
                                    424 ;	testpreempt.c:68: EA = 1;
                                    425 ;	assignBit
      0000A3 D2 AF            [12]  426 	setb	_EA
                                    427 ;	testpreempt.c:70: }
      0000A5 80 DD            [24]  428 	sjmp	00101$
                                    429 ;------------------------------------------------------------
                                    430 ;Allocation info for local variables in function 'Consumer'
                                    431 ;------------------------------------------------------------
                                    432 ;	testpreempt.c:77: void Consumer(void)
                                    433 ;	-----------------------------------------
                                    434 ;	 function Consumer
                                    435 ;	-----------------------------------------
      0000A7                        436 _Consumer:
                                    437 ;	testpreempt.c:85: TMOD |= 0x20;
      0000A7 43 89 20         [24]  438 	orl	_TMOD,#0x20
                                    439 ;	testpreempt.c:90: TH1 = (unsigned char)-6;
      0000AA 75 8D FA         [24]  440 	mov	_TH1,#0xfa
                                    441 ;	testpreempt.c:98: SCON = 0x50;
      0000AD 75 98 50         [24]  442 	mov	_SCON,#0x50
                                    443 ;	testpreempt.c:103: TI = 0;
                                    444 ;	assignBit
      0000B0 C2 99            [12]  445 	clr	_TI
                                    446 ;	testpreempt.c:108: TR1 = 1;
                                    447 ;	assignBit
      0000B2 D2 8E            [12]  448 	setb	_TR1
                                    449 ;	testpreempt.c:118: while (!bufferFull)
      0000B4                        450 00101$:
      0000B4 E5 31            [12]  451 	mov	a,_bufferFull
      0000B6 60 FC            [24]  452 	jz	00101$
                                    453 ;	testpreempt.c:126: EA = 0;
                                    454 ;	assignBit
      0000B8 C2 AF            [12]  455 	clr	_EA
                                    456 ;	testpreempt.c:131: if (bufferFull)
      0000BA E5 31            [12]  457 	mov	a,_bufferFull
      0000BC 60 0D            [24]  458 	jz	00108$
                                    459 ;	testpreempt.c:137: SBUF = sharedBuffer;
      0000BE 85 30 99         [24]  460 	mov	_SBUF,_sharedBuffer
                                    461 ;	testpreempt.c:138: bufferFull = 0;
      0000C1 75 31 00         [24]  462 	mov	_bufferFull,#0x00
                                    463 ;	testpreempt.c:144: EA = 1;
                                    464 ;	assignBit
      0000C4 D2 AF            [12]  465 	setb	_EA
                                    466 ;	testpreempt.c:146: while (!TI)
      0000C6                        467 00104$:
                                    468 ;	testpreempt.c:153: TI = 0;
                                    469 ;	assignBit
      0000C6 10 99 EB         [24]  470 	jbc	_TI,00101$
      0000C9 80 FB            [24]  471 	sjmp	00104$
      0000CB                        472 00108$:
                                    473 ;	testpreempt.c:161: EA = 1;
                                    474 ;	assignBit
      0000CB D2 AF            [12]  475 	setb	_EA
                                    476 ;	testpreempt.c:164: }
      0000CD 80 E5            [24]  477 	sjmp	00101$
                                    478 ;------------------------------------------------------------
                                    479 ;Allocation info for local variables in function 'main'
                                    480 ;------------------------------------------------------------
                                    481 ;	testpreempt.c:173: void main(void)
                                    482 ;	-----------------------------------------
                                    483 ;	 function main
                                    484 ;	-----------------------------------------
      0000CF                        485 _main:
                                    486 ;	testpreempt.c:178: sharedBuffer = 0;
      0000CF 75 30 00         [24]  487 	mov	_sharedBuffer,#0x00
                                    488 ;	testpreempt.c:179: bufferFull = 0;
      0000D2 75 31 00         [24]  489 	mov	_bufferFull,#0x00
                                    490 ;	testpreempt.c:180: nextCharacter = 'A';
      0000D5 75 32 41         [24]  491 	mov	_nextCharacter,#0x41
                                    492 ;	testpreempt.c:185: ThreadCreate(Producer);
      0000D8 90 00 81         [24]  493 	mov	dptr,#_Producer
      0000DB 12 01 1C         [24]  494 	lcall	_ThreadCreate
                                    495 ;	testpreempt.c:191: Consumer();
                                    496 ;	testpreempt.c:192: }
      0000DE 02 00 A7         [24]  497 	ljmp	_Consumer
                                    498 ;------------------------------------------------------------
                                    499 ;Allocation info for local variables in function '_sdcc_gsinit_startup'
                                    500 ;------------------------------------------------------------
                                    501 ;	testpreempt.c:198: void _sdcc_gsinit_startup(void)
                                    502 ;	-----------------------------------------
                                    503 ;	 function _sdcc_gsinit_startup
                                    504 ;	-----------------------------------------
      0000E1                        505 __sdcc_gsinit_startup:
                                    506 ;	testpreempt.c:202: __endasm;
      0000E1 02 00 EE         [24]  507 	LJMP	_Bootstrap
                                    508 ;	testpreempt.c:203: }
      0000E4 22               [24]  509 	ret
                                    510 ;------------------------------------------------------------
                                    511 ;Allocation info for local variables in function '_mcs51_genRAMCLEAR'
                                    512 ;------------------------------------------------------------
                                    513 ;	testpreempt.c:210: void _mcs51_genRAMCLEAR(void) {}
                                    514 ;	-----------------------------------------
                                    515 ;	 function _mcs51_genRAMCLEAR
                                    516 ;	-----------------------------------------
      0000E5                        517 __mcs51_genRAMCLEAR:
      0000E5 22               [24]  518 	ret
                                    519 ;------------------------------------------------------------
                                    520 ;Allocation info for local variables in function '_mcs51_genXINIT'
                                    521 ;------------------------------------------------------------
                                    522 ;	testpreempt.c:211: void _mcs51_genXINIT(void) {}
                                    523 ;	-----------------------------------------
                                    524 ;	 function _mcs51_genXINIT
                                    525 ;	-----------------------------------------
      0000E6                        526 __mcs51_genXINIT:
      0000E6 22               [24]  527 	ret
                                    528 ;------------------------------------------------------------
                                    529 ;Allocation info for local variables in function '_mcs51_genXRAMCLEAR'
                                    530 ;------------------------------------------------------------
                                    531 ;	testpreempt.c:212: void _mcs51_genXRAMCLEAR(void) {}
                                    532 ;	-----------------------------------------
                                    533 ;	 function _mcs51_genXRAMCLEAR
                                    534 ;	-----------------------------------------
      0000E7                        535 __mcs51_genXRAMCLEAR:
      0000E7 22               [24]  536 	ret
                                    537 ;------------------------------------------------------------
                                    538 ;Allocation info for local variables in function 'timer0_ISR'
                                    539 ;------------------------------------------------------------
                                    540 ;	testpreempt.c:222: void timer0_ISR(void) __interrupt(1)
                                    541 ;	-----------------------------------------
                                    542 ;	 function timer0_ISR
                                    543 ;	-----------------------------------------
      0000E8                        544 _timer0_ISR:
                                    545 ;	testpreempt.c:226: __endasm;
      0000E8 02 02 59         [24]  546 	LJMP	_myTimer0Handler
                                    547 ;	testpreempt.c:227: }
      0000EB 02 00 54         [24]  548 	ljmp	sdcc_atomic_maybe_rollback
